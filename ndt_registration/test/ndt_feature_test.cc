...
int main(int argc, char **argv)
{
    ...
    desc.add_options()("help", "produce help message")("x", po::value<double>(&pose_increment_v(0))->default_value(1.), "x pos gt offset")("y", po::value<double>(&pose_increment_v(1))->default_value(1.), "y pos gt offset")("z", po::value<double>(&pose_increment_v(2))->default_value(1.), "z pos gt offset")("X", po::value<double>(&pose_increment_v(3))->default_value(0.1), "x axis rot gt offset")("Y", po::value<double>(&pose_increment_v(4))->default_value(0.1), "y axis rot gt offset")("Z", po::value<double>(&pose_increment_v(5))->default_value(0.1), "z axis rot gt offset")("nb_clusters", po::value<int>(&nb_clusters)->default_value(20), "number of clusters")("nb_points", po::value<int>(&nb_points)->default_value(10), "number of points per clusters")("std_dev", po::value<double>(&std_dev)->default_value(0.1), "standard deviation of the points drawn from a normal distribution (here independent on the axes")("min", po::value<double>(&min)->default_value(-10), "minimum center point")("max", po::value<double>(&max)->default_value(10), "maximum center point")("lazzy", "use lazzygrid")("p2preg", "calculate NDTMatchF2F using two pointclouds")("irregular_grid", "use irregular grid in the p2p registration")("nfeaturecorr", "feature_f2f should NOT be evaluated (NDTMatcherFeatureF2F)")("singleres", "use single resolution in the 'p2p' matching")("nf2f", "if f2f should NOT be evaluated")("usegt", "if the ground truth should be used as initial estimate");
