...
int main(int argc, char **argv)
{
    ...
    desc.add_options()("help", "produce help message")("base-name", po::value<string>(&base_name), "pre-string of the files to be loaded, relative to current working directory")("number", po::value<int>(&n_scans)->default_value(1), "number of scans to process")("fuser", po::value<bool>(&doFuser)->default_value(false), "run ndt fuser instead")("resolution", po::value<double>(&resolution)->default_value(1.), "resolution of the map for ndt fuser");
