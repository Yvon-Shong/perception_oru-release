    ...
    bool computeHessian)
{
    ...
    if (computeHessian)
    {
        Hessian += factor * (2 * Jest.transpose() * B * Jest + 2 * xtBH - xtBZhBx - 2 * xtBZBJ.transpose() - 2 * xtBZBJ + xtBZBZBx + xtBZBZBx.transpose() - lfd2 * Q * Q.transpose() / 2);
    }
    return true;
}
                                                  ...
                                                  bool computeHessian)
{
    ...
    if (computeHessian)
    {
        ...
        _ZHest.block<3, 3>(6, 6) << 2 * C1(1, 1) - 2 * C1(0, 0), -4 * C1(0, 1), -C1(0, 2),
...
void NDTMatcherD2D_2D::computeDerivatives_2d(Eigen::Vector3d &x, Eigen::Matrix3d C1, bool computeHessian)
{
    ...
    if (computeHessian)
    {
        ...
        ZHest.block<3, 3>(6, 6) << 2 * C1(1, 1) - 2 * C1(0, 0), -4 * C1(0, 1), -C1(0, 2),
            -4 * C1(0, 1), 2 * C1(0, 0) - 2 * C1(1, 1), -C1(1, 2),
            -C1(0, 2), -C1(1, 2), 0;
    }
}
